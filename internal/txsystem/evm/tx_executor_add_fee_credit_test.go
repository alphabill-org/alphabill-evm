...
import (
	...
	testblock "github.com/alphabill-org/alphabill-evm/internal/testutils/block"
	"github.com/alphabill-org/alphabill-evm/internal/testutils/logger"
	testsig "github.com/alphabill-org/alphabill-evm/internal/testutils/sig"
	testtb "github.com/alphabill-org/alphabill-evm/internal/testutils/trustbase"
...
func TestAddFC_ValidateAddNewFeeCreditTx(t *testing.T) {
	...
	t.Run("Invalid proof", func(t *testing.T) {
		...
		require.NoError(t, tx.UnmarshalAttributes(&attr))
		require.EqualError(t, feeCreditModule.validateAddFC(tx, &attr, &authProof, execCtx),
			"proof is not valid: verify tx inclusion: proof block hash does not match to block hash in unicity certificate")
	})
}
